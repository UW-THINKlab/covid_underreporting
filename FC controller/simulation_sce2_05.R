...
#E_0 <- 7
I_0 <- 39 #412    
R_0 <- 34 #345    #### look up in the simulation study design document Table X
...
write.csv(dataset_scenario, "/Users/gracejia/Documents/A-UW/covid19 NSF Project/scenario2_05.csv", row.names = F)
plot(beta_t, type="l", xlab="Days forward (from May 15)",ylab="",cex.lab=1.4)
par(new=T)
